...
(function() {
    ...
    class CPUManager {
        ...
        setQuality(level) {
            ...
            console.log(`CPU Manager: Quality changed from ${oldLevel} to ${level} (Sample Rate: ${this.qualityPresets[level].sampleRate}Hz, Buffer: ${this.qualityPresets[level].bufferSize})`);
        }
