  ...
  function triggerAttack(noteName, when, amplitude) {
    ...
    for (var idx = 0; idx < slotsToPlay.length; idx++) {
      ...
      if (isJsPreset) {
        ...
        // Subtle slowdown across the whole ultimate envelope: slight tape/Doppler feel as notes die.
        // Start at note-on, reach about 3% lower pitch/time by the end of the 6s outer fade.
        var slowTarget = playbackRate * 0.97; // ~3% pitch/time drop at ultimateOffTime
