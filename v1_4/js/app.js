...
(function() {
    ...
    const App = {
        ...
        resumeAudioContext: function() {
            ...
            // Also ensure WaterSynth's context is resumed (if different and exists)
            if (this.player && this.player.waterSynth && this.player.waterSynth.audioContext) {
                const waterContext = this.player.waterSynth.audioContext;
                if (waterContext && waterContext.state === 'suspended') {
                    promises.push(waterContext.resume());
                }
            }
