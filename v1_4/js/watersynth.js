...
class WaterSynth {
    constructor() {
        ...
        this.reverbGain.gain.value = 0.75; // Reduced reverb for mobile headroom (was 0.85)
        this.masterGain.gain.value = 0.7; // Reduced master gain for mobile headroom (was 0.9)
