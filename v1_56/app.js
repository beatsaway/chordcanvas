        ...
        synthSegments.forEach((segment) => {
            if (segment.bassEvents && segment.bassEvents.length) {
                scheduleSynthPlay(() => {
                    ...
                    engine.play(
                        { events: segment.bassEvents, durationSeconds: segment.durationSeconds },
                        null,
                        null,
            ...
            if (segment.trebleEvents && segment.trebleEvents.length) {
                scheduleSynthPlay(() => {
                    ...
                    engine.play(
                        { events: segment.trebleEvents, durationSeconds: segment.durationSeconds },
                        null,
                        null,
                        { overlap: true, preloadSeconds: SYNTH_PRELOAD_SECONDS }
                    );
    ...
    if (isSynthEnabled()) {
        ...
        if (bassEvents.length) {
            ...
            if (engine) {
                ...
                engine.play(
                { events: bassEvents, durationSeconds: durationSeconds + 0.05 },
                null,
                null,
                { overlap: true, preloadSeconds: SYNTH_PRELOAD_SECONDS }
                );
        ...
        if (trebleEvents.length) {
            ...
            if (engine) {
                ...
                engine.play(
                { events: trebleEvents, durationSeconds: durationSeconds + 0.05 },
                null,
                null,
                { overlap: true, preloadSeconds: SYNTH_PRELOAD_SECONDS }
                );
