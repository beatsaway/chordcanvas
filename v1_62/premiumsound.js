(() => {
    ...
    function resolvePreset(name, context = {}) {
      ...
      if (typeof provider === "function") {
        ...
        if (preset && preset.oscillators && preset.attack != null) {
          return preset;
        }
      }
      ...
      if (typeof fallbackProvider === "function") {
        ...
        if (fallback && fallback.oscillators && fallback.attack != null) {
          return fallback;
        }
      }
      return {
    ...
    function setMasterVolume(value = 0.9) {
      ...
      const volume = Math.max(0, Math.min(4, value)); // allow up to 400%
