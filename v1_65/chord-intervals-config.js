...
// 
// DESIGN PHILOSOPHY: Multi-octave orchestral voicing
// This configuration creates rich, thick chord sounds by layering:
// 1. Sub-bass layer (-24): Root note 2 octaves below (for deep foundation)
// 2. Bass layer (-12, -5): Root and 5th one octave below (for bass support)
// 3. Main chord layer (0+): The actual chord tones in the middle register
//
// This approach is excellent for:
// - Orchestral/ambient sound design
// - Creating full, rich textures
// - Ensuring bass presence even when high notes are played
//
// Note: Each chord has 5-8 notes total, creating a "chord palette" that can be
// selectively used. The visualization shows all notes, but in practice you might
// only use a subset based on the musical context.
//
...
const CHORD_INTERVALS = {
    ...
    // 11th Chords
    // Sub-bass root, then root and 5th an octave lower, then original 11th chord
    'dominant-11th': [-24, -12, -5, 0, 4, 7, 10, 14, 17], // Sub-bass: Root | Bass: Root, 5th | Main: Root, Major 3rd, Perfect 5th, Minor 7th, Major 9th, Perfect 11th
    'minor-11th': [-24, -12, -5, 0, 3, 7, 10, 14, 17],    // Sub-bass: Root | Bass: Root, 5th | Main: Root, Minor 3rd, Perfect 5th, Minor 7th, Major 9th, Perfect 11th
    'major-11th': [-24, -12, -5, 0, 4, 7, 11, 14, 17],     // Sub-bass: Root | Bass: Root, 5th | Main: Root, Major 3rd, Perfect 5th, Major 7th, Major 9th, Perfect 11th
    
    // 13th Chords
    // Sub-bass root, then root and 5th an octave lower, then original 13th chord
    'dominant-13th': [-24, -12, -5, 0, 4, 7, 10, 14, 21],   // Sub-bass: Root | Bass: Root, 5th | Main: Root, Major 3rd, Perfect 5th, Minor 7th, Major 9th, Major 13th
    'major-13th': [-24, -12, -5, 0, 4, 7, 11, 14, 21],      // Sub-bass: Root | Bass: Root, 5th | Main: Root, Major 3rd, Perfect 5th, Major 7th, Major 9th, Major 13th
    'minor-13th': [-24, -12, -5, 0, 3, 7, 10, 14, 21],      // Sub-bass: Root | Bass: Root, 5th | Main: Root, Minor 3rd, Perfect 5th, Minor 7th, Major 9th, Major 13th

    // Add Chords
    // Sub-bass root, then root and 5th an octave lower, then original add chord
    'add2': [-24, -12, -5, 0, 2, 4, 7],               // Sub-bass: Root | Bass: Root, 5th | Main: Root, Major 2nd, Major 3rd, Perfect 5th
    'add4': [-24, -12, -5, 0, 4, 5, 7],               // Sub-bass: Root | Bass: Root, 5th | Main: Root, Major 3rd, Perfect 4th, Perfect 5th
    ...
    // 6/9 Chord
    'six-nine': [-24, -12, -5, 0, 4, 7, 9, 14],       // Sub-bass: Root | Bass: Root, 5th | Main: Root, Major 3rd, Perfect 5th, Major 6th, Major 9th
    
    // Altered Chords
    // Sub-bass root, then root and 5th an octave lower, then original altered chord
    'dominant-7th-flat9': [-24, -12, -5, 0, 4, 7, 10, 13], // Sub-bass: Root | Bass: Root, 5th | Main: Root, Major 3rd, Perfect 5th, Minor 7th, Flat 9th
    'dominant-7th-sharp9': [-24, -12, -5, 0, 4, 7, 10, 15],// Sub-bass: Root | Bass: Root, 5th | Main: Root, Major 3rd, Perfect 5th, Minor 7th, Sharp 9th
    'dominant-7th-flat5': [-24, -12, -6, 0, 4, 6, 10],     // Sub-bass: Root | Bass: Root, Flat 5th | Main: Root, Major 3rd, Flat 5th, Minor 7th
    'dominant-7th-sharp5': [-24, -12, -4, 0, 4, 8, 10],    // Sub-bass: Root | Bass: Root, Sharp 5th | Main: Root, Major 3rd, Sharp 5th, Minor 7th
    ...
    'minor-major-7th': [-24, -12, -5, 0, 3, 7, 11],    // Sub-bass: Root | Bass: Root, 5th | Main: Root, Minor 3rd, Perfect 5th, Major 7th
    'half-diminished-7th': [-24, -12, -6, 0, 3, 6, 10],// Sub-bass: Root | Bass: Root, Dim 5th | Main: Root, Minor 3rd, Diminished 5th, Minor 7th
    ...
    'dominant-7th-sus4': [-24, -12, -5, 0, 5, 7, 10],  // Sub-bass: Root | Bass: Root, 5th | Main: Root, Perfect 4th, Perfect 5th, Minor 7th
    'dominant-9th-sus4': [-24, -12, -5, 0, 5, 7, 10, 14] // Sub-bass: Root | Bass: Root, 5th | Main: Root, Perfect 4th, Perfect 5th, Minor 7th, Major 9th
};
