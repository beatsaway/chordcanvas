...
(function() {
    ...
    const UIController = {
        ...
        init: function() {
            ...
            // Start with test panel disabled
            this.setTestPanelEnabled(false);
        },
        ...
        cacheElements: function() {
            this.elements = {
                ...
                playPaletteSound: document.getElementById('playPaletteSound'),
        ...
        /**
         * Get whether to play palette sound
         * @returns {boolean} True if palette sound should be played
         */
        getPlayPaletteSound: function() {
            return this.elements.playPaletteSound ? this.elements.playPaletteSound.checked : true;
        },
