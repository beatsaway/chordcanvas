...
(function() {
    ...
    /**
     * Same velocity→amplitude as live playback, for WAV export so export matches what you hear.
     * @param {number} velocity - MIDI velocity (0-127)
     * @param {number} midiNote - MIDI note number
     * @returns {number} - Amplitude (0-1)
     */
    window.getVelocityAmplitudeForExport = function(velocity, midiNote) {
        ...
        return velocityToAmplitudeWithCompensation(velocity, midiNote, k, targetSPL);
    };
