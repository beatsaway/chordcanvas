...
(function() {
    ...
    class AudioManager {
        constructor() {
            ...
            this.dryGain = null;
            this.baseVolume = 0.8; // Increased from 0.5 for modern web audio standards
            ...
            this.autogainTargetLevel = -9; // Target RMS level in dB (increased from -12 for louder output)
        ...
        initialize() {
            ...
            // Buffer size hint silently applied
            ...
            this.dryGain.gain.value = 0.15; // Increased from 0.025 for better presence
            this.reverbGain.gain.value = 0.5; // Increased from 0.4 for more reverb presence
        ...
        reinitializeForQuality() {
            ...
            // Quality change will apply on next initialization
        }
    }
