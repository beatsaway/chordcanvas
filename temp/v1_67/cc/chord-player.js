...
(function () {
    ...
    function readSoundStateFromGlobals() {
        ...
        if (typeof window !== 'undefined' && window.synth) {
            if (typeof window.synth.getNostalgiaMode === 'function') nostalgia = window.synth.getNostalgiaMode();
        ...
        return { presetSlots: slots, slotVolumes: vols, slotSemitones: semis, slotMuted: muted, everyBarPattern: everyBar, everyBarIntensity: everyBarInt, layerPlayStyle, layerPlayMode, reverb, stereoWidth, nostalgia, rowVolume, soundBassEveryBar, soundTrebleEveryBar, soundBassEveryBarIntensity, soundTrebleEveryBarIntensity };
    }
    ...
    function applySoundStateToGlobals(state) {
        ...
        if (window.synth) {
            ...
            if (window.synth.setNostalgiaMode) window.synth.setNostalgiaMode(!!state.nostalgia);
    ...
    function init() {
        ...
        function syncSoundPanelFromFocusedRow() {
            ...
            const nostalgiaEl = document.getElementById('cc-sound-nostalgia');
            ...
            if (nostalgiaEl) nostalgiaEl.checked = !!state.nostalgia;
        ...
        (function bindSoundPanelControls() {
            ...
            function updateRowSoundFromPanel() {
                ...
                if (nostalgiaEl) state.nostalgia = nostalgiaEl.checked;
            ...
            ['cc-sound-reverb', 'cc-sound-stereo', 'cc-sound-nostalgia', 'cc-sound-row-volume'].forEach(function (id) {
                const el = document.getElementById(id);
                if (!el) return;
            ...
            if (kind === 'wav') {
                (async () => {
                    try {
                        ...
                        wavOptions.nostalgiaMode = (window.gslSynth && typeof window.gslSynth.getNostalgiaMode === 'function' && window.gslSynth.getNostalgiaMode());
