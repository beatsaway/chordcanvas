...
const trebleNotesResetBtn = document.getElementById('trebleNotesResetBtn');
const trebleNotesApplyBtn = document.getElementById('trebleNotesApplyBtn');
...
if (trebleNotesResetBtn) {
    trebleNotesResetBtn.addEventListener('click', () => {
        if (!trebleModalState) return;
...
if (trebleNotesApplyBtn) trebleNotesApplyBtn.addEventListener('click', applyTrebleModal);
