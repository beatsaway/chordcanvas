        ...
        init: function() {
            try {
                ...
                if (window.CPUManager) {
                    ...
                    window.CPUManager.setQualityChangeCallback((level, oldLevel) => {
                        console.log(`CPU Manager: Quality adjusted from ${oldLevel} to ${level} (FPS: ${Math.round(window.CPUManager.getFPS())})`);
                    });
                }
